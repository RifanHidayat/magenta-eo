...
class PurchaseReceipt extends CI_Controller {
...
function index(){
    ...
    $this->load->view('purchase-receipt/index',$this->data);
...
function update($id){
 ...
 function detail($id){
    $purchaseReceipt=$this->db->query("SELECT * FROM purchase_receipt where id=".$id)->row_array();
    ...
    $this->load->view('tamplate/header',$this->data);
    $this->load->view('tamplate/sidebar',$this->data);
    $this->load->view('purchase-receipt/detail',$this->data);
    $this->load->view('tamplate/footer',$this->data);
}

public function datatablesPurchaseReceipt(){
    $this->load->model("model_purchase_receipt");  
    $fetch_data = $this->model_purchase_receipt->make_datatables();  
    $data = array();  
    ...
    { 
         ...
         <a href="'.base_url("/purchasereceipt/detail/".$row->id).'" class="btn-delete" data-id="' . $row->id . '"><em class="icon fas fa-credit-card"></em>
         Detail</a>
    ...
    $output = array(  
         ...
         "recordsTotal"          =>      $this->model_purchase_receipt->get_all_data(),  
         "recordsFiltered"     =>     $this->model_purchase_receipt->get_filtered_data(),  
         "data"                    =>     $data  
    );  
