...
public function manage_delivery(){
    ...
    $this->db->select('Delivery_number,delivery.quotation_number,quotations.customer_event as customer,tittle_event,gudang,date_pengiriman,faktur.status as statusFaktur,bast.status as statusBast,quotations.status as statusQuotations,delivery.status as status,id_delivery');
	   	...
	   	$this->data['delivery']=$this->db->get()->result();
	   		  ...
	   		  $this->db->select('Delivery_number,delivery.quotation_number,quotation_other.customer_event as customer,tittle_event,gudang,date_pengiriman,faktur.status as statusFaktur,bast.status as statusBast,quotation_other.status as statusQuotations,delivery.status as status,id_delivery');
      	  	$this->db->from('quotation_other');
		...
		$delivery_number=$this->input->post("delivery_number");
		   ...
		   $this->db->select('*');
            ...
            $this->db->join('faktur','faktur.id_bast = bast.id_bast');
             $this->db->join('delivery','delivery.id_faktur = faktur.id_faktur');  
...
public function print_delivery($quotation_number,$id){
 ...
 if ($idd=="QE"){
    ...
    // $this->load->view('tamplate/header1',$this->data);
    // //$this->load->view('tamplate/sidebar',$this->data);
    // $this->load->view('delivery/print_delivery',$this->data);
    //  $this->load->view('tamplate/footer1',$this->data);
    ...
    $data=$this->db->get()->row_array();
      ...
      $this->db->select('*');
      $this->db->from('faktur');
      $this->db->where('id_faktur',$quotation_number);
      $data=$this->db->get()->row_array();
