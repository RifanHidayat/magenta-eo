...
class model_delivery extends CI_Model
{
     ...
     function make_query()
     {
          $this->db->select('Delivery_number,delivery.quotation_number,quotations.customer_event as customer,tittle_event,gudang,date_pengiriman,bast.status as statusFaktur,bast.status as statusBast,quotations.status as statusQuotations,delivery.status as status,delivery.id_delivery as id_delivery,delivery.noteStatus');

          $this->db->from('quotations');
          $this->db->join('bast', 'bast.quotation_number = quotations.quotation_number');

          $this->db->join('delivery', 'bast.id_bast = delivery.id_bast');
     ...
     {
          $this->db->select('Delivery_number,delivery.quotation_number,quotation_other.customer_event as customer,tittle_event,gudang,date_pengiriman,bast.status as statusFaktur,bast.status as statusBast,quotation_other.status as statusQuotations,delivery.status as status,delivery.id_delivery as id_delivery,delivery.noteStatus');
