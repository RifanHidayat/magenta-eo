...
class model_quotationother extends CI_Model
{
    var $table = "quotation_other";
        ...
        var $select_column = array("quotation_number","sisa_bast", "date_quotation","date_expired", "customer", "tittle_event","netto","pic_name","pic_email","asf","note","ppn","pph23","asfp","total","image","id","pic_event","customer_event","email_event","status","id_customer","id_event","id_po","noteStatus","sub_total",'po_number'); 
