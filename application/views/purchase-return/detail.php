...
<div class="content-wrapper">
  ...
  <div class="content" id="app">
    ...
    <span class="text-secondary ml-3 text-lg  " >No. Retur : <span class="text-primary">{{purchaseReceiptCode}}<span></span>
                                    ...
                                    <tbody>
                                        ...
                                        <tr  v-for="(receipt, index) in historyReceiptProducts">
                                            ...
                                            <td><span >{{receipt.name}}</span></td>
                                              <td><span >{{receipt.cause=="1"?"Barang Rusak / Cacat":"Barang Tidak Sesuai"}}</span></td>
    ...
    $('#datatableProducts tbody').on('click', '.btn-choose', function() {
         ...
         response.data.data.map((item)=>{
          ...
          console.log("error")
           ...
           axios.get(`${API_URL}/api/purchase-return/<?php echo $purchaseOrderId ?>/history`).then((response)=>{
            ...
            purchaseReceipt.map((item)=>{
                historyReceiptProducts.push(item.purchase_return_product[0])
                console.log("item",item.purchase_return_product[0])
