    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="box-title"><b>Manage Supplier</b></h3>
          <div class="card-tools" style="margin-top: -35px;margin-right: 3px">
            <?php if (in_array('createCustomer', $user_permission)) : ?>
              <a href="<?php echo base_url('Supplier/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Supplier</a>
            <?php endif; ?>
          </div>
        </div>
  ...
  let API_URL="http://localhost:3000";
    $(document).ready(function() {
      var dataTable = $('#customerTable').DataTable({
        ...
        "order": [],
        "ajax": {
          url: "<?php echo base_url("Supplier/datatablesSupplier") ?>",
          type: "POST"
        },
        "columnDefs": [{
    ...
    function destroy(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return axios.delete(`${API_URL}/api/supplier/` + id)
