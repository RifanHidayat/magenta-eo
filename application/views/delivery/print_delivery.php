...
<body>
    ...
    <div class="row">
     ...
     <table style="width: 200px;margin-top: 20px;" border="1" align="right" >
          
          <tr>
            
            <th style="width: 70px"><center>Tanggal Pengiriman</center></th><td><center><?php echo $date_pengiriman ?></center></td>
           <center>

          </tr>
          <tr>
            
            <th style="width: 70px"><center>Gudang</center></th><td><center><?php echo  $gudang; ?></center></td>
             
            
          </tr>
           <tr>
            
            <th style="width: 70px"><center>Pengirim</center></th><th><center><?php echo $pengirim; ?></center></th>
           

          </tr>
           <tr>
            
            <th style="width: 70px">PO No.<center></center></th><td><center><?php echo  $po_number; ?></center></td>
    ...
    <!-- /.row -->    <div class="row invoice-info">
      <div class="col-9 invoice-col"  >
        <br>
                      <p style="margin-top: -80px;">PT.Magenta Mediatama<br>
