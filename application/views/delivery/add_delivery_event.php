              ...
              <form action="<?php base_url('Delivery/create_delivery/' . $quotation_number) ?>" method="post" id="SimpanData" name="formid">
                ...
                <div class="col-md-6 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group" id="qnumber">
                    ...
                    <div class="col-sm-12">
                      <input onkeypress="return false;" onchange="generet_delivery()" onkeypress="return false;" type="text" placeholder="dd/mm/yy" class="form-control" required="" id="tanggal_pengiriman" name="tanggal_pengiriman" autocomplete="off">
