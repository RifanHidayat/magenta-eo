   ...
   .visible {
      ...
      <section class="content">
        ...
        <div class="card-tools" style="margin-top: -35px;margin-right: 15px">
          <a href="<?php echo base_url('Delivery/manage_delivery') ?>" class="btn bg-gradient-secondary"><font color="white">Back</font></a>
          </div>
     ...
     <div class="form-group" id="qnumber"  hidden="">
               ...
               <?= form_error('customer_other','<small class="text-danger pl-3">','</small>')?>
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input  required=""  type="text" class="form-control" required=""  id="platnomor" name="platnomor" autocomplete="off">
