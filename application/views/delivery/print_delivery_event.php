          ...
          <div class="float-right">
            ...
            <table style=" width: 50px;margin-top: -50px;" align="right">
              ...
              <tr>
                ...
                <td style="width: 130px; margin-top: -50px;">
                  <center><b>
                      <font color="black" size=3>Delivery Order</font>
                    </b></center>
                  <hr style="width: 100%">
                  <center>
                    <p align="top">Delivery Order No: <?php echo $delivery_order; ?></p>
                  </center>
                </td>
            ...
            <table style="width: 200px;margin-top: 30px;" border="1" align="right">
              ...
              <tr>
                ...
                <td>
                  <center><?php echo $date_pengiriman ?></center>
                </td>
                <center>
              ...
              <tr>
                ...
                <th style="width: 130px">PO No.<center></center>
                </th>
                <td>
                  <center><?php echo  $po_number; ?></center>
                </td>
        ...
        <table style=" width: 200px" border="1">
          ...
          <tr>
            ...
            <th style="width: 200px">
              <center>Tagihan Ke</center>
            </th>
            <th style="width: 200px">
              <center>Kirim Ke</center>
            </th>
