            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
               ...
               <?= form_error('customer_other','<small class="text-danger pl-3">','</small>')?>
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input onchange="generet_delivery()" type="text" class="form-control" required=""  id="tanggal_pengiriman" placeholder="yyyy-mm-dd" name="tanggal_pengiriman" autocomplete="off">
        ...
        <table  class="table" border="0" id="tablefaktur" border="1">
                                      <thead>
                                          <tr>
                                                 ...
                                                 <th style="width: 1%"><a  style="width: 5" class="btn btn-sm bg-gradient-secondary" data-toggle="tooltip"  id="hapus"><font color="white"> <i class="fa fa-times"><font color="white"></i></font></a></th>
...
function BarisBaruFaktur() {
                  ...
                  var Baris = '<tr id=trfaktur'+Nomor+'>';
                          ...
                          Baris += '</td>';
                            ...
                            Baris += '<td>';
                              Baris += '<input  type="text" name="deskripsibarang[]"  oninput="hitungDescription();"  id="DescriptionBarang'+Nomor+'" class="form-control FrequencyDescription" >';
                          Baris += '</td>';
                 ...
                 <?php 
                  ...
                  var Baris = '<tr id=trfaktur'+Nomor+'>';
                          ...
                          Baris += '</td>';
                            ...
                            Baris += '<td>';
                              Baris += '<input  type="text" name="deskripsibarang[]"  oninput="hitungDescription();" value="<?php echo $k->desciption; ?>"   id="DescriptionBarang'+Nomor+'" class="form-control FrequencyDescription" >';
                          Baris += '</td>';
