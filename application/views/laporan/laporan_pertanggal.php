      ...
      <section class="content">
        <div class="card">
           <div class="card-header">
            ...
            <h3 class="box-title">Laporan Per Tanggal</h3>
...
<form action="<?php echo base_url('Laporan/aksi_laporan_tanggal') ?>" method="post" id="SimpanData" name="formid">
            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
                    ...
                    <label>
                    <input required="" type="radio" name="jenis_laporan" id="jenis_laporan" value="detail">
                      Detail
                    </label>
                    <label>
                      <input required="" type="radio" name="jenis_laporan" id="jenis_laporan" value="total">
                      Total
                    </label>
                  </div>
                          ...
                          <table style="width: 730px;">
                            <tr>
                              <th><br>Pilih Tanggal</th>
                               <td> &ensp;<input id="tanggalm" name="tanggalm" required=""  type="date" cols="30" class="form-control" autocomplete="off" ></td>
                                <td>&ensp;<br>Sampai</td>
                                <td><br><input id="tanggals" name="tanggals" required=""  type="date" cols="30" class="form-control" autocomplete="off" ></td>
                            </tr>
                          </table>
                          </div>
                     ...
                     <div class="form-group text-left">
                                      <button type="submit" class="btn btn-success" name="tombol" value="excel"> Laporan Excel</button>
                                        <button type="submit" class="btn btn-danger" name="tombol" value="pdf"> Laporan PDF</button>
