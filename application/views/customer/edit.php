...
<div class="card-tools" style="margin-top: -35px;margin-right: 3px">
         <a href="<?php echo base_url('Customer/manage_customer') ?>" class="btn btn-secondary"><font color="white">Back</font></a>
          </div>
      ...
      <div class="row">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('Customer/add_customer/'.$id); ?>" method="post" name="formid">
              <div class="box-body">
