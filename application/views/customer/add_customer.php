     ...
     <div class="card">
       <div class="card-header">
         ...
         <div class="card-tools" style="margin-top: -35px;margin-right: 3px">
           <a href="<?php echo base_url('Customer/manage_customer') ?>" class="btn bg-gradient-secondary">
         ...
         <div class="row">
           <div class="col-md-12 col-xs-12">
             ...
             <div class="box">
               ...
               <form id="SimpanData" action="<?php base_url('Customer/add_customer'); ?>" method="post" name="formid">
                 <div class="box-body">
