      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('dashboard/add_customer'); ?>" method="post" name="formid">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Customer Name" autocomplete="off" value="<?php echo set_value('name')?>">
                </div>
                 <?= form_error('name','<small class="text-danger pl-3">','</small>')?>
                 <div class="form-group">
                  <label for="address">Customer Address</label>
                  <input type="text" cols="30" class="form-control" id="address" name="address" placeholder="Customer Address" autocomplete="off" value="<?php echo set_value('address')?>">
                </div>
                 <?= form_error('address','<small class="text-danger pl-3">','</small>')?>

                  <div class="form-group">
                  <label for="phone">Customer Phone</label>
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Customer Phone" autocomplete="off" value="<?php echo set_value('phone')?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="npwp" name="npwp" placeholder="NPWP" autocomplete="off" value="<?php echo set_value('npwp')?>">
                </div>
                     <?= form_error('npwp','<small class="text-danger pl-3">','</small>')?>

                     <div class="form-group">
                  <label for="groups">PIC PO</label>
                  <select class="form-control" id="pic" name="pic" style="width:99%;" onchange="DataPIC()" value="<?php echo set_value('pic')?>">
                  ...
                  <input type="text"  readonly class="form-control" id="jabatan" name="jabatan" placeholder="jabatan" autocomplete="off" value="<?php echo set_value('jabatan')?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="email" readonly class="form-control" id="email" name="email" placeholder="Email" autocomplete="off" value="<?php echo set_value('email')?>">
                </div>
                ...
                <a href="<?php echo base_url('dashboard/manage_customer') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
