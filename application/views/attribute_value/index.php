      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('dashboard/add_value_attribute'.$id); ?>" method="post">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('dashboard/manage_attribute_value/'.$id) ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
