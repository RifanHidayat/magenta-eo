      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php endif; ?>
            ...
            <a href="<?php echo base_url('dashboard/add_attribute') ?>" class="btn btn-primary">Add item value</a>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Manage Attrribute</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                    ...
                    <?php foreach ($attribute as $k): ?>
                      <tr>
                        ...
                        <td><font color="#FFFFFF" size="2px"><a class="btn btn-primary btn-xs" href="<?php echo base_url("dashboard/manage_attribute_value")?>"><i class="fa fa-plus"></i><font size="2px"> ADD VALUE</a>
                        ...
                        <font color="#FFFFFF" size="2px"><a class="btn btn-danger btn-xs" onclick="swetalert('<?php echo $k->id?>')"><i class="fa fmanage_attribute_valuea-?trash"></i><font size="2px"> HAPUS</a>'</td>    
                      </tr>
                    <?php endforeach ?>
  ...
  <div class="modal-dialog" role="document" data-keyboard="false">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">Ubah Data Item</h4>
           ...
           <form role="form" action="<?php base_url('dashboard/add_attribute'); ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Name Attribute" autocomplete="off">
                </div>
                 <?= form_error('name','<small class="text-danger pl-3">','</small>')?>

                  <div class="form-group">
                  <label for="jabatan">Status</label>
                  <input type="text" class="form-control" id="status" name="status" placeholder="Status" autocomplete="off">
                </div>
...
<script type="text/javascript">
  ...
  if (result.value) {
    $.ajax({
        url : "<?php echo base_url("dashboard/hapus_attribute/3") ?>",
        type:"post",
        data:{id:id},
        success:function(){
            Swal.fire(
  ...
  function AmbilData(id){
      $.ajax({
          type:"post",
          url:'<?php echo base_url("dashboard/ambilIdAttribute/3")?>',
          data:{id:id},
          dataType:'json',
...
function Ubahdata(){
    ...
    if (v.trim()==''){
        ...
        url :'<?php echo base_url("dashboard/aksi_update_data_attribute")?>',
        dataType:'json',
        success:function(hasil){
          Swal.fire(
        'success!',
