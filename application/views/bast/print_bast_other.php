...
<head>
  <title><?php echo $bast_number; ?></title>
  <style type="text/css">
    .ttd1 {
      float: right;
    ...
    <section class="invoice">
      <div class="Contaier">
        <div class="header">
          ...
          <center>
            <h3 align="center">PT.Magenta Mediatama<br> Berita Acara<br><?php echo $bast_number; ?></h3>
          </center>
        ...
        <div class="body">
          ...
          <table style="margin-left: 4%">
            <tr>
              <td td align="justify"> <span>dalam hal ini bertindak untuk dan atas nama PT. Magenta Mediatama yang berkedudukan di jl. Raya Kebayoran Lama No. 15 Grogol Utara Jakarta Selatan 12210 untuk selanjutnya disebut sebagai <b> PIHAK KEDUA</b></span>
              </td>
            </tr>
          </table><br>
