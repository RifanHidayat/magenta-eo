  ...
  ?>
            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input onkeypress="return false;" type="date" class="form-control" required="" id="date_po" name="date_po" autocomplete="off"  value="<?php echo $date_po ?>" >
                </div>
                ...
                <div class="form-group"id="qnumber">
                  ...
                  <br>
                              ...
                              <div class="form-group text-left">
                                      ...
                                      <a href="<?php echo base_url('Bast/manage_bast') ?>" class="btn btn-warning"><font color="white"> Back</font></a>
