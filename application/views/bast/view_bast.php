      ...
      <section class="content">
        <div class="card">
           ...
           <div class="card-tools" style="margin-top: -35px;margin-right: 11px">
                <a href="<?php echo base_url('Bast/manage_bast') ?>" class="btn btn-secondary"><font color="white">Back</font></a>
            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
               ...
               <?= form_error('venue_event','<small class="text-danger pl-3">','</small>')?>
                ...
                <div class="form-group"id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input  type="text" required="" value="<?php echo $sisaBast ?>"class="form-control" id="total_summary" readonly="" name="sisaBast"  autocomplete="off" value="<?php echo set_value('title_event')?>">
                </div>
                </div>
