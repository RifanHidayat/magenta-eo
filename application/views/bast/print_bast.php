      ...
      <div class="Contaier">
        ...
        <div class="body">
          ...
          <table style="margin-left: 4%">
            <tr>
              <td align="justify"> <span>dalam hal ini bertindak untuk dan atas nama <?php echo $customer; ?> yang berkedudukan di <?php echo $alamat . ""; ?> untuk selanjutnya disebut sebagai <b>PIHAK PERTAMA</b></span> </td>
            </tr>
          </table>
