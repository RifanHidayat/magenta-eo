  ...
  ?>
            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input onkeypress="return false;" type="text" placeholder="yyyy-mm-dd" class="form-control" required="" id="date_po" name="date_po" autocomplete="off"  value="<?php echo $date_po ?>" >
                </div>
