    ...
    <div class="card" id="app">
      <div class="card-header">
        ...
        <div class="card-tools" style="margin-top: -35px;margin-right: 3px">
          <a href="<?php echo base_url('produtt') ?>" class="btn btn-secondary">
...
let API_URL="http://localhost:3000";
    let   app=new  Vue({
        ...
        data:{
            ...
            purchasePrice:"<?php echo $purchase_price ?>",
            sellingPrice:"<?php echo $selling_price?>",
        ...
        methods: {
            ...
            sendData:function(){
                ...
                axios.patch(`${API_URL}/api/product/<?php echo $id ?>`,{

                    
                    code:vm.code,
                    name:vm.name,
                    purchase_price:vm.purchae_price,
