      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-tools" style="margin-top: -35px;margin-right: 11px">
             <a style="margin-left: 3%" href="<?php echo base_url('Quotation/manage_quotation_other') ?>" class="btn btn-secondary"><font color="white"> Back</font></a>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <br>
          ...
          <tr>
            ...
            <td>IDR <p align="right" style="margin-top: -21px;"><?php echo $k->unitprice ?></p></td>
