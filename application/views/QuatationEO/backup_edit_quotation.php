          ...
          <?php endif; ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="box-title">Edit Quotation EO</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="col-md-12">
                  ...
                  <div class="col-md-12" style="margin: 10px;">
                      <div class="box box-solid">
                          ...
                          <form action="<?php echo base_url('Quotation/aksi_update_quotation') ?>" method="post" id="SimpanData" name="formidevent" class="form-horizontal" enctype="multipart/form-data">
        ...
        var hitung1 =hitung.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.");
         ...
         $("#grandtotalcoshidden<?php echo(str_replace(' ', '', $k->name)); ?>").val(hitung);
          ComissionableCost();
              ...
              $(document).on('click', '#hapusbaris<?php echo $k->name?>', function(e) {
   ...
   function defaul<?php echo (str_replace(' ', '', $k->name)) ?> () {
    <?php  foreach ($quotationitem as $it): ?>
              ...
              <?php if ($k->name==$it->name_item) {?>
                  ...
                  Baris += '<td>';
                  Baris += '<input  type="text"    name="subtotal[]" id="subtotal<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal"  required="" readonly >  <input  type="text"  readonly name="subtotal<?php echo (str_replace(' ', '', $k->name)) ?>[]" id="subtotalhidden<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly hidden  > <input hidden  type="text"  readonly name="name[]" id="name<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="<?php echo $k->name ?>"> <input  type="text"  readonly name="metode[]" id="metode<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="Comissionable Cost" hidden> <input  type="text"  readonly name="id[]" id="id<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="<?php echo $it->id ?>" hidden> ';
              ...
              <?php if ($k->name==$it->name_item) {?>
                  ...
                  var Baris = '<tr id=tr<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'>';
                          ...
                          Baris += '</td>';
                            ...
                            Baris += '<td>';
                              Baris += '<input  type="text"   name="subtotal[]" id="subtotalNON<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly >  <input  type="text"  readonly name="rate<?php echo (str_replace(' ', '', $k->name)) ?>[]" id="subtotalhiddenNON<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly hidden > <input hidden  type="text"  readonly name="name[]" id="name<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="<?php echo $k->name ?>">  <input  type="text"  readonly name="metode[]" id="metode<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="Non-Fee Cost" hidden> <input  type="text"  readonly name="id[]" id="id<?php echo (str_replace(' ', '', $k->name)) ?>'+Nomor+'"  class="form-control subtotal_creative"  required="" readonly value="<?php echo $it->id ?>" hidden> ';
                          Baris += '</td>';
...
//----------------perhitungan------------------------------------------------------
    ...
    initialPreview: [
      '<object type="application/pdf" data="<?php echo base_url('assets/images_/'.$img)?>" style="height: 30vh; width:50vh"><img style="width: 10%; height: 30% "  src="<?php echo base_url('assets/images_/'.$img) ?>" ></object>'
  ],
    });
//get pic even even
 function DataPIC(){
