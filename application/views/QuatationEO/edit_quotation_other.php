         ...
         <div class="form-group" id="qnumber" hidden="">
               ...
               <?= form_error('customer_event','<small class="text-danger pl-3">','</small>')?>
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <input type="text"  class=" col-sm-7 form-control" value="0"   id="asf_percen_other" oninput="hitungnetto();" name="asf_percen_other" oninput="hitungasf();"  name="asf_percen_other" autocomplete="off"  >
                  ...
                  <table  class="table" border="0" id="tableLoopDescription">
                                      <thead>
                                          <tr>
                                              ...
                                              <th style="width: 5%"><center>Frequency</center></th>
                                        ...
                                        <td></td>
                                          <td></td>
                                             ...
                                             <th style="text-align:left;">Grand Total</th><th colspan="2" >
                                              ...
                                              <input id="grandtotaldescription" readonly="" style="width:80%" type="text" class="form-control" required=""> <input id="grandtotaldescriptionhidden" readonly="" style="width:80%" type="text" class="form-control" required="" hidden="" ></th>
                                               </tr>
                 
                                        </tfoot>
                                    </table>
                                         <div class="form-group text-left">
                                      <button value="update" type="submit"  name="btn" class="btn btn-primary"></i>Save Changes</button>
                                    <!--    <button value="revisi" type="submit" class="btn btn-success" name="btn"></i>Save as Revision</button> -->
                                      
                                        <button value="revisi" type="submit" class="btn btn-success btnSave" name="btn" type="button" >
  ...
  function BarisBaruDescription() {
      <?php 
                  ...
                  var Baris = '<tr id=trdescription'+Nomor+'>';
                           ...
                           Baris += '<td style="width:30%" colspan=2>';
                              Baris += '<input  type="text" value="<?php echo $k->desciption; ?>" name="description[]" id="description'+Nomor+'"  class="form-control deposit"  required="" >';
                          Baris += '</td>';
