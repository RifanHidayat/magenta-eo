      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-tools" style="margin-top: -35px;margin-right: 11px">
             <a style="margin-left: 3%" href="<?php echo base_url('Quotation/manage_quotation') ?>" class="btn btn-secondary"><font color="white"> Back</font></a>
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12" style="margin: 10px;">
                   ...
                   <?php if(in_array('statusQuatations', $user_permission)): ?>
                          <button  style="border: none; border-radius: 5px;margin-left: 5%" for="pid_event" disabled="" style="width: 50%;"
                    class="col-sm-2 control-label btn-primary">
                    <font color="white">Save Changes</font></button>
                  <?php endif; ?>
                  ...
                  <textarea readonly="" style="margin-left: -150px; width:20% " type="text" class="form-control" id="note" name="note"  autocomplete="off"></textarea>
                   ...
                   <?php if(in_array('statusQuatations', $user_permission)): ?>
                          <button  style="border: none; border-radius: 5px;margin-left: 5%" for="pid_event"onclick="updateStatus();" style="width: 50%;"
                    class="col-sm-2 control-label btn-primary">
                    <font color="white">Save Changes</font></button>
                  <?php endif; ?>
          ...
          <thead class="thead-dark" >
              <tr>
                ...
                <td style="width: 5%" ><center><?php echo $no; ?></center></td>
                  ...
                  <td style="width: 10%"><center><?php echo $k->quantity." ".$k->satuanq ; ?></center></td>
                  <td style="width: 10%"><center><?php echo $k->frrequency." ".$k->satuanf ; ?></center></td>
                  <td style="width: 15%">IDR <p align="right" style="margin-top: -21px;"><?php echo $k->rate; ?></p></td>
                  <td style="width: 20%">IDR <p align="right" style="margin-top: -21px;"> <?php echo $k->subtotal ; ?></p></td>
                </tr>
              <?php  }?>
           <?php  endforeach ?>
            ...
            <th colspan="5">Grand Total</th>
             ...
             <th>IDR <p align="right" style="margin-top: -21px;"><?php echo number_format($total,0,",","."); ?></p></th>
          ...
          success:function(hasil){
            console.log(hasil);
               ...
               $('#customerEvent').val(hasil[0].customer_event);
                ...
                $('#ppn').val(hasil[0].ppn);
                $('#pph').val(hasil[0].pph);
                $('#total_summary').val(hasil[0].total_summary.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1."));
