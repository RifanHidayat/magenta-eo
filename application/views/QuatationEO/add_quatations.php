 ...
 <div class="card-header">
  ...
  <br><br>
      <div class="col-md-10 col-xs-10 pull pull-right" >
                  ...
                  <input type="number"  class=" col-sm-7 form-control" placeholder="0" required="" name="asf_percen"   id="asf_percen" oninput="hitungasf();"  name="asf_percen" autocomplete="off"  >
                ...
                <div class="form-group" id="kanan">
                  <label id="asflabel" for="Quatations_number"  style="text-align:left;" class="col-sm-2 control-label" id>Discount</label>
                    <div class="col-sm-4" id="kananasf">
                  <input type="number"  class=" col-sm-7 form-control" placeholder="0" required="" name="discount_percent_event" step="any"   id="discount_percent_event" oninput="discount_event_function()"  name="discount_percen" autocomplete="off"  >
                   <label for="Quatations_number" style="text-align:left;" class="col-sm-1 control-label" >%</label>
        ...
        <br>
                 ...
                 <!--   other -->
                  ...
                  <label for="pph"style="text-align:left;" class="col-sm-6 control-label" >File quotation other</label>
                   <div class="col-sm-12">
                 <input accept=".jpg,.png,.jpeg,.pdf"  id="imagenesother" onchange="ValidateSizeother(this)" name="imagenesother" type="file" 
            ...
            <div class="col-md-6 col-xs-12 pull pull-left" >
               ...
               <?= form_error('customer_event','<small class="text-danger pl-3">','</small>')?>
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <label id="asflabel" for="Quatations_number"  style="text-align:left;" class="col-sm-2 control-label" id>ASF</label>
                    <div class="col-sm-4" id="kananasf">
                  <input type="number"  class=" col-sm-7 form-control" placeholder="0"   id="asf_percen_other" oninput="hitungnetto();" name="asf_percen_other"  autocomplete="off"  >
                   <label for="Quatations_number" style="text-align:left;" class="col-sm-1 control-label" >%</label>
                ...
                <div class="form-group" id="qnumber">
                  <label id="asflabel" for="Quatations_number"  style="text-align:left;" class="col-sm-2 control-label" id>Discount</label>
                    <div class="col-sm-4" id="kananasf">
                  <input type="number"  class=" col-sm-8 form-control" placeholder="0" required="" name="discount_percent_other"   id="discount_percent_other" oninput="discount_other_function()"  name="discount_percen_other" autocomplete="off"  >
                   <label for="Quatations_number" style="text-align:left;" class="col-sm-1 control-label" >%</label>
                  
                </div>
              
                   <div class="col-sm-12">
                  <input type="text" readonly="" class="col-sm-12 form-control" id="discount_other" name="discount_othera" autocomplete="off" readonly="" value="0">
                   <input type="text" readonly="" class="form-control" id="discount_event_hidden" name="discount_event_hidden" autocomplete="off" readonly="" value="0" hidden="">
                </div>
...
/// simpan data quotation event
    ...
    function ComissionableCost(){
       ...
       function ppn(){
        ...
        'onclick="alert(\'Call your custom code here.\')">' +
        '<i class="glyphicon glyphicon-tag"></i>' +
        '</button>';   var a=Math.round(hitung); 
            var hitung1 =a.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1.");
