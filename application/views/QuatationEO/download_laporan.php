...
<img  id="imagedeposit" src="<?php echo base_url('images/logo.png') ?>" alt="" class="logo" width="200" height="100" style="float: right; "/>
    ...
    <div class="row">
       ...
       <hr   style="height: 5px; border-width: 6px; width: 99.5%; background-color:#696969;"  >
              ...
              <thead  >
              <tr>
                  <th scope="col" style="width: 8%" ><center>No</center></th>

                  <th scope="col" colspan="3" style="width: 65%" ><center>Description</center></th>
                  <th style="width: 40%" scope="col" ><center>total</center></th>
              ...
              <tr>
                  ...
                  <?php
                   ...
                   <?php if ($k->metode=="Non-Fee Cost") {
                    ...
                    ?>            
                <tr>
                <td style="width: 8%" ><center><?php echo $no; ?></center></td>
           ...
           <tr>
             ...
             <td colspan="4"  ><b>Grand Total</b></td><td  align="right">IDR <?php echo $nonfee; ?></td>
            </tr>
            <tr>
           ...
           <tr>
            ...
            <td colspan="4"><b>Grand Total</b></td><td  align="right">IDR <?php echo  $comissionable_cost; ?></td>
           </tr>

             <tr>
            <td rowspan="5" colspan="3"></td>
             
            <td colspan="1" style="width: 20%"><b>ASF</b></td><td style="width: 35%"  align="right" ><b>IDR <?php echo  $asf; ?></b></td>
           </tr>
             <tr>
          
            <td colspan="1"><b>Sub Total</b></td><td  align="right"><b>IDR <?php echo  $total; ?></b></td>
           </tr></b>
           <tr>
           <td colspan="1" style=""><b>PPN</b></td><td  align="right"><b>IDR <?php echo $ppn; ?></b></td>
           </tr>
            <tr>
           <td colspan="1"><b>PPh</b></td><td  align="right"><b>IDR <?php echo  $pph; ?></b></td>
           </tr>
           <tr>
          
            <td colspan="1"><b>Grand Total</b></td><td  align="right"><b>IDR <?php echo  $grand_total; ?></b></td>
           </tr></b>
        ...
        <h4><b>Non-Fee Cost</b></4> 
             <?php
              ...
              <center><h6  align="center"><?php  echo  $name->name ?></h6></center>
          ...
          <thead class="thead-dark" >
              <tr>
                  ...
                  <th style="width: 12%"><center>Quantity</center></th>
                  <th style="width: 12%"><center>Frequency</center></th>
                  <th style="width: 15%"><center>Rate </center></th>
                  <th><center style="width: 20%">Sub Total</center> </th>
              </tr>
              </thead>
                ...
                <td style="width: 8%"><center><?php echo $no; ?></center></td>
                  ...
                  <td style="width: 2%"><center><?php echo $k->quantity." ".$k->satuanq ; ?></center></td>
                  <td style="width: 2%"><center><?php echo $k->frrequency." ".$k->satuanf ; ?></center></td>
                  <td style="width: 15%"  align="right"><right>IDR <?php echo $k->rate; ?></right></td>
        ...
        <h4><b>Comissionable Cost</b></h4>
             <?php
              ...
              <tr>
                  <th scope="col" style="width: 8%"><center>No</center></th>
                  <th scope="col" style="width: 25%"><center>Description</center></th>
                  <th scope="col" style="width: 10%"><center>Quantity</center></th>
                  <th scope="col" style="width: 10%"><center>Frequency</center></th>
                  <th scope="col" style="width: 20%"><center>Rate </center></th>
                  <th scope="col" style="width: 25%"><center>Sub Total</center> </th>
              </tr>
              </thead>
                ...
                <td style="width: 8%"><center><?php echo $no; ?></center></td>
                  <td style="width: 25%"><?php echo $k->item_value ; ?></td>
                  <td style="width: 12%"><center><?php echo $k->quantity." ".$k->satuanq ; ?></center></td>
                  <td style="width: 12%"><center><?php echo $k->frrequency." ".$k->satuanf ; ?></center></td>
