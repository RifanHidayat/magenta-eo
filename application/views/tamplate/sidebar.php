...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <!--           <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url("Bank/add_bank")?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Saldo PIC PO</p>
                </a>
              </li>
              <?php endif; ?>
               <?php if(in_array('updateBank', $user_permission) || in_array('viewbank', $user_permission) || in_array('deleteBank', $user_permission)): ?>
              <li class="nav-item">
                <a href="<?php echo base_url("Bank/manage_bank")?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Salo PIC PO</p>
                </a>
              </li>
              <?php endif; ?>
            </ul>
        ...
        <!--     <ul class="nav nav-treeview">
                ...
                <?php if(in_array('updateDelivery', $user_permission) || in_array('viewDelivery', $user_permission) || in_array('deleteDelivery', $user_permission)): ?>
              <li class="nav-item">
                <a href="<?php echo base_url("Delivery/manage_delivery")?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Delivery</p>
                </a>
              </li>
