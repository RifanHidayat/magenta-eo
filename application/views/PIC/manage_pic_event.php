    ...
    <!-- Main content -->
      ...
      <section class="content">
        ...
        <div class="card">
            ...
            <h3 class="box-title"><b>Manage PIC Event</b></h3>
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="piceventTable" class="table table-bordered table-striped">
                <thead>
                <tr>
  ...
  <div class="modal-dialog" role="document" data-keyboard="false">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Edit Data PIC Event</b></h4>
  ...
  <script type="text/javascript">
      ...
      var dataTable = $('#piceventTable').DataTable({  
           "processing":true,  
           "serverSide":true,  
                  "responsive": true,
      "autoWidth": false,
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url("PicPO/TampilDatapicevent")?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
  ...
  if (result.value) {
    $.ajax({
        url : "<?php echo base_url("PicPO/hapus_pic_event/3") ?>",
        type:"post",
        data:{id:id},
        success:function(){
            Swal.fire(
      ...
      'success'
          ...
          $('#piceventTable').DataTable().ajax.reload();
  ...
  function AmbilData(id){
      $.ajax({
          type:"post",
          url:'<?php echo base_url("PicPO/ambilIdPICEvent/3")?>',
          data:{id:id},
          dataType:'json',
...
url :'<?php echo base_url("PicPO/aksi_update_data_pic_event") ?>',
dataType:'json',
success:function(hasil){
                      Swal.fire({
  title: "success!",
...
function datatable(){
      ...
      if (data.length==0){
          ...
          '</tr>';
             ...
             '<td>'+data[i].pic_name+'</td>'+
              ...
              '<font color="#FFFFFF" size="2px"><a class="btn btn-sm bg-gradient-secondary" title="Edit" onclick="AmbilData('+data[i].id_event+')" data-toggle="modal" data-target="#update"><i class="fa fa-edit"></i> </a>'+
              '<?php endif; ?>'+

              'ensp;<?php if(in_array('deletePicPO', $user_permission)): ?>'+
              '<font color="#FFFFFF" size="2px"><a class="btn btn-sm bg-gradient-secondary" title="Delete" onclick="swetalert('+data[i].id_event+')"><i class="fa fa-trash"></i><font size="2px"></a></font>'+
              '<?php endif; ?><center>'+
  ...
  $("#managePICEventNav").addClass('active');
