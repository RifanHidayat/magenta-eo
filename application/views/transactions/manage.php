  ...
  try {
    ...
    axios.get(`http://localhost:3000/api/faktur/transactions`).then((response)=>{
      ...
      response.data.data.map((value)=>{
        const print= value.account.id!=null?`<font color="#FFFFFF"  size="2px"><a title="Print" class="btn btn-sm bg-gradient-secondary"   href="http://localhost/magentaeo/Transactions/print/${value.id}" target="_blank"><i class="fa fa-print"></i><font size="2px"> </a>`:"";
        row+=`
        <tr>
          <td>
          ...
          <?php endif ?>
          <?php if (in_array('printTransactions', $user_permission)) : ?>
          ${print}
          <?php endif ?>
        ...
        // <font color="#FFFFFF" size="2px"><a class="btn btn-sm bg-gradient-secondary"  title="Delete"><i class="fa fa-trash"></i><font size="2px"></a>
        //   </font></center>
      })
