  ...
  <br>
      ...
      <?php if ($jml==1){ ?>
          ...
          <tr>
            ...
            <td><center><?php echo $k->deskripsi_barang ?></center></td>
            <td><?php echo $k->keterangan ?></td>
            <td><center><?php echo $k->kts ?></center></td>
             <td>IDR <p align="right" style="margin-top: -21px;"> <?php echo $k->harga_satuan ?></p></td>
              <td>IDR <p align="right" style="margin-top: -21px;"> <?php echo $k->amount ?></p></td>
           ...
           <tfoot>
             ...
             <tr >
              ...
              <td  rowspan="8" colspan="5"><b>Terbilang :</b><p id="terbilang1" name="terbilang1"></p></td>
            </tr>
            <tr>
              <th>Total Sub</th>
              <th>IDR <p align="right" style="margin-top: -21px;"><?php echo $total_sub ?></p></th>
             
            </tr>
            <tr>
              <th>ASF</th>
              <th>IDR <p align="right" style="margin-top: -21px;"><?php echo $asf ?></p></th>
            ...
            <tr>
             ...
             <tr>
              <th>PPN</th>
         <th>IDR <p align="right" style="margin-top: -21px;">  <?php echo $ppn ?></p></th>
              
            </tr>
             <tr>
              <th>PPh23</th>
            <th>IDR  <p align="right" style="margin-top: -21px;"><?php echo $pph23; ?></p></th>
            
            </tr>
             <tr>
              <th>Total Faktur</th>
           <th>IDR <p align="right" style="margin-top: -21px;">  <?php echo $total_faktur; ?></p></th>
          ...
          <tr>
            ...
            <td><center><?php echo $k->kts ?></center></td>
             <td>IDR <p align="right" style="margin-top: -21px;"> <?php echo $k->harga_satuan ?></p></td>
              <td hidden="">IDR <p align="right" style="margin-top: -21px;"> <?php echo $k->amount ?></p></td>
