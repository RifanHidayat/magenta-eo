<div class="content-wrapper">
 ...
 <ul class="nav nav-pills mb-2" id="pills-tab" role="tablist">
              ...
              <button  onclick="location.href='<?php echo base_url('Faktur/manage_faktur_event/') ?>'"   type="button" class="btn btn-outline-primary">Quotation Event</i></button>
               </li>&ensp;
                ...
                <table id="fakturTable" class="table table-bordered table-striped" style="width: 100%">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 9%">Quotation Number</th>
                      <th style="width: 9%">Faktur Number</th>
                      <th style="width: 8%">Date Faktur</th>
...
<script type="text/javascript">
  $(document).ready(function() {
    var dataTable = $('#fakturTable').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo base_url("Faktur/TampilDatafakturother") ?>",
        type: "POST"
      },
      "columnDefs": [{
