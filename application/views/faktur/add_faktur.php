  ...
  ?>
               ...
               <?= form_error('customer_other','<small class="text-danger pl-3">','</small>')?>
                ...
                <select class="form-control" required="" id="syarat_pembayaran" name="syarat_pembayaran" style="width:99%;" onchange="DataPIC()"> value="<?php echo set_value('picEvent')?>">
                  ...
                  <table class="table"   border="0" id="tablefaktur">
                                      <thead>
                                          <tr>
                                           
                      
                                                 <th><a hidden=""  style="width: 5" class="btn btn-sm bg-gradient-secondary" data-toggle="tooltip"  id="hapus"><font color="white"> <i class="fa fa-times"><font color="white"></i></font></a></th>
                                      ...
                                      <tbody></tbody>
                                        ...
                                        <td></td>
                                         ...
                                         <td style="display: flex; margin: 0;top: 10px;"><p><b>Diskon</b></p><input hidden style="width: 70px; margin-left: 80px;" type="number" oninput="hitungdiskon();"    class="form-control" id="diskon" name="diskon"  autocomplete="off" placeholder="0" value="<?php echo set_value('email_other')?>">     <p hidden  style="margin-left: 5px; margin-top: 5px;">%</p>  </td>
                 ...
                 <?php  
                  ...
                  var Baris = '<tr id=trfaktur'+Nomor+'>';
                          ...
                          Baris += '</td>';
                            ...
                            Baris += '<td>';
                              Baris += '<input  type="text" name="deskripsibarang[]"   value="<?php echo $k->desciption; ?>"   id="DescriptionBarang'+Nomor+'" class="form-control FrequencyDescription" >';
                          Baris += '</td>';
