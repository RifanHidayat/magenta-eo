...
<div class="card-body">
  ...
  ?>
                ...
                <div class="form-group" id="qnumber">
                  ...
                  <div class="col-sm-12">
                  <input onkeypress="return false;" type="text" class="form-control" required="" id="date_faktur" name="date_faktur" placeholder="yyyy-mm-dd" autocomplete="off" value="<?php echo set_value('date_faktur')?>" >
                </div>
                  ...
                  <table  class="table" border="0" id="tablefaktur" border="1">
                                      <thead>
                                          <tr>
                                                 ...
                                                 <th style="width: 1%"><a hidden=""  style="width: 5" class="btn btn-sm bg-gradient-secondary" data-toggle="tooltip"  id="hapus"><font color="white"> <i class="fa fa-times"><font color="white"></i></font></a></th>
                                      ...
                                      <tbody></tbody>
                                        ...
                                        <td></td>
                                         <td></td>
                                          ...
                                          <td style="display: flex; margin: 0;top: 10px;"><p><b>Diskon</b></p><input style="width: 70px; margin-left: 80px;" type="number" oninput="hitungdiskon();"    class="form-control" id="diskon" name="diskon"  autocomplete="off" placeholder="0" value="<?php echo set_value('email_other')?>">     <p style="margin-left: 5px; margin-top: 5px;">%</p>  </td>
