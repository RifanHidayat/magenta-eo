                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div style="width:100%;">
                            <div style="overflow-x:auto;width:100%">
                                <table class="table" border="0" id="tablefaktur" style="width:140%">
                                    <thead>
                                        <tr>
                          ...
                          <font color="white"> <i class="fa fa-times">
                              <font color="white">
                                            ...
                                            <th style="width: 10%" colspan="2">Barang</th>
...
<script type="text/javascript">
    ...
    function DataQuotation(id) {
        $.ajax({
            ...
            success: function(hasil) {
                ...
                $('#hasildiskon').val(hasil[0].discount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1."));
                $('#diskon').val(hasil[0].discount_percent.toString());
    ...
    function BarisBaruFaktur() {
        ...
        <?php } else { ?>
            ...
            Baris += '<input hidden oninput="hitungFaktur();" type="text" name="amount[]" id="amount' + Nomor + '"  class="form-control deposit"  required="" readonly  >  <input    type="text" name="ammountHidden[]" id="amounthidden' + Nomor + '"  class="form-control AmountHidden"  required="" readonly hidden  >';
    ...
    function TambahBarisBaruFaktur() {
        ...
        ?>
            ...
            Baris += '<td>';
            Baris += '<input hidden  oninput="hitungFaktur();"  value="<?php echo $k->frequency; ?>"   type="text" name="amount[]" id="amount' + Nomor + '"  class="form-control deposit"  required="" readonly  >  <input    type="text" name="ammountHidden[]" id="amounthidden' + Nomor + '"  class="form-control AmountHidden"  required="" readonly hidden  >';
            Baris += '</td>';
            Baris += '<td class="text-center">';
    ...
    function TambahBarisBaruFaktur1() {
        ...
        ?>
            ...
            tinymce.init({
                selector: 'textarea#DescriptionBarang' + Nomor,
                height: 200,
                menubar: false,
                plugins: [
                    'advlist autolink lists link image charmap print preview anchor',
