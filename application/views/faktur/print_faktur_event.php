  ...
  <div class="row invoice-info">
      <div class="col-9 invoice-col">
        <br>
            ...
            <br>phone (021) 53660077-08;Fax(021)53660099</p>
            <font size="2">
    ...
    <div class="col-13 table-responsive justify-content">
              ...
              <tr>
                  <th scope="col" style="width: 10%;"><center>No</center></th>
                  <th scope="col" style="width: 50%;" colspan="4"><center>Description</center></th>
                  <th scope="col" style="width: 40%;" colspan="1"><center>Total</center></th>
                 ...
                 <!--  <td align="right"><p align="right">IDR 
                    ...
                    echo number_format($total,0,",",".");
                     ...
                     ?>
                      ...
                      <th align="right"> <p align="right"><?php echo "IDR ".$jasa; ?></th>
                       
              </tr>
               <tr>
                  <td><center>2</center></td> 
                 <td colspan="4">Jasa - ASF </td>
                  <th align="right"> <p align="right"><?php echo "IDR ".$asf; ?></th>
                   ...
                   <td style="border: none"  colspan="4" rowspan="5" valign="top" ><p style="margin-top: -150px">Terbilang : <?php terbilang(str_replace('.', '', $total_faktur)) ?></td>
                  <th style="width: 20%">Subtotal</th> 

                     <th style="width: 30%;" align="right"><p align="right">
                    <?php
                    //$fee=(str_replace('.', '', $nonfee));
                    $asff=(str_replace('.', '', $asf));
                  ...
                  <th >PPh23</th> 
                     ...
                     <th align="right"s><p align="right">
                    <?php
