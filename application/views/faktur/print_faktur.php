        ...
        <table style="width: 92%;margin-left: 45px;" id="tbl1" align="center" style="margin: auto;" border="1" align="center">
          ...
          <tr>
            ...
            <th style="width: 10%"><center>Barang</center></th>
             <th style="width: 20%"><center>Deskripsi Barang</center></th>
               <th style="width: 20%"><center>Keterangan</th>
            <th style="width: 5%"><center>KTS</center></th>
            <th style="width: 20%"><center>Harga Satuan</center></th>
            <th style="width: 30%"><center>Ammount</center></th>
          </tr>
          </thead>
          ...
          <tr>
            ...
            <td><center><?php echo $k->kts ?></center></td>
             <td align="right"><p align="right"><?php echo 'IDR '.$k->harga_satuan ?></p></td>
             <td hidden="" align="right"><p align="right"><?php echo 'IDR '.$k->amount ?></p></td>
          ...
          <tr>
           ...
           <?php }
             ...
             <tr >
              ...
              <td style="border: none"  rowspan="7" colspan="5" valign="top"><p style="margin-top: -150px">Terbilang : <?php terbilang(str_replace('.', '', $total_faktur)) ?></p></td>

              <th style="width: 15%">Total Sub</th>
              <th style="width: 30%" align="right"><p align="right"> <?php echo 'IDR '.$jasa ?></th></p>
             
            </tr>
             <tr>
               <th>ASF</th>
                       <th style="width: 20%" align="right"><p align="right"> <?php echo 'IDR '.$asf ?></p></th>
              
             
            </tr>
            <tr>
               <th>Total</th>
                       <th style="width: 20%" align="right"><p align="right"> <?php echo 'IDR '.$total ?></p></th>
              
             
            </tr>
             <tr>
               <th>Diskon <?php if ($diskon==""){echo "0%";}else{ echo $diskon."%";} ?>
                    
              <th align="right"><p align="right">
                    <?php
                    if ($diskon==""){
                        echo "(0)";
            ...
            <tfoot>
             ...
             <tr>
              <th>PPN</th>
         <th align="right"><p align="right"> <?php echo 'IDR '.$ppn ?></p></th>
              
            </tr>
             <tr>
              <th>PPh23</th>
            <th align="right"><p align="right"> <?php echo 'IDR '.$pph23; ?></p></th>
            
            </tr>
             <tr>
              <th>Total Faktur</th>
           <th align="right"><p align="right"> <?php echo 'IDR '.$total_faktur; ?></p></th>
      ...
      <div class="col-6">
        ...
        <br>
          ...
          <tr>
            ...
            <td style="width: 200px"><center>Hormat Kami</center></td>
           

          </tr>
          <tr>
            
            <td style="width: 150px"><center>PT. Magenta Mediatama</center></td>
          ...
          <tr>
           ...
           <tr>
            ...
            <td style="width: 150px"><center>Yo Tinco</center></td>
