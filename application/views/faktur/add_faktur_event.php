   ...
   .visible {
      ...
      <section class="content">
        ...
        <div class="card-tools" style="margin-top: -35px;margin-right: 17px">
          <a href="<?php echo base_url('Bast/manage_bast') ?>" class="btn bg-gradient-secondary"><font color="white">Back</font></a>
          </div>
               ...
               <?= form_error('customer_other','<small class="text-danger pl-3">','</small>')?>
                  ...
                  <table class="table border"   border="0" id="tablefaktur">
                                      ...
                                      <tbody>
                                        ...
                                        <td   colspan="3"  style="display: flex;"> Material -<p style="margin-left: 5px; margin-top: 0px;" id="tevent" name="tevent" ></p></td>
                                        ...
                                        <td  colspan="2">Material - <p style="margin-left: 5px; margin-top: 0px;" id="tevent" name="tevent" ></p></td>
                                        ...
                                        <td style="display: flex; margin: 0;top: 10px;"><p><b>Discount</b></p><input hidden style="width: 70px; margin-left: 80px;" type="number" oninput="hitungdiskon();"    class="form-control" id="diskon" name="diskon"  autocomplete="off" placeholder="0" value="<?php echo set_value('email_other')?>">     <p hidden style="margin-left: 5px; margin-top: 5px;">%</p>  </td>
                                      ...
                                      <td style="display: flex; margin: 0;top: 10px;"><p><b>Netto</b></p><input hidden style="width: 70px; margin-left: 80px;" type="number" oninput="hitungdiskon();"    class="form-control" id="diskon" name="diskon"  autocomplete="off" placeholder="0" value="<?php echo set_value('email_other')?>">     <p hidden style="margin-left: 5px; margin-top: 5px;">%</p>  </td>
