     ...
     <table class="col-10 table justify-center table-bordered" align="center" style="margin: auto;" border="1" align="center">
              ...
              <tr>
                  ...
                  <td colspan="3">Material-<?php echo $title; ?></td> 
                         ...
                         <th>IDR <p align="right" style="margin-top: -21px;"> <?php echo "$material"; ?></p> </th>
              </tr>
               <tr>
                 ...
                 <td colspan="3">Jasa-ASF</td>
                    ...
                    <th >IDR <p align="right" style="margin-top: -21px;"> <?php echo "$as"; ?></p></th>
               ...
               <tr>
                   ...
                   <td colspan="3" rowspan="5" ><b>Terbilang :</b></b><p id="terbilang1" name="terbilang1"></p></td>
