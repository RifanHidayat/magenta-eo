                                      ...
                                      <tbody>
                                        ...
                                        <td> <input type="text" readonly=""  class="form-control" id="subtotal" name="subtotal"  autocomplete="off" value="<?php echo set_value('email_other')?>"></td>
                                         ...
                                         <td></td>
                                          ...
                                          <td style="display: flex; margin: 0;top: 10px;"><p><b>Discount</b></p><input style="width: 70px; margin-left: 80px;" type="number" hidden oninput="hitungdiskon();"    class="form-control" id="diskon" name="diskon"  autocomplete="off" placeholder="0" value="<?php echo set_value('email_other')?>">     <p hidden style="margin-left: 5px; margin-top: 5px;">%</p>  </td>
