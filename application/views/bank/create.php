 ...
 <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="text" onkeyup="convertToRupiah(this);"   readonly id="hasil" name="hasil" style="width:50%"  class="form-control"   > 
                    </div>
                   ...
                   <input readonly style="width:50%" type="text" class="form-control" id="id" name="id" hidden="" value="<?php echo $id?>"> 
                                ...
                                <br>
                                  <table class="table table-bordered" id="tableLoop">
                                      ...
                                      <td>
                                      <input type="text"  name="deposit[]" value="<?php  echo $k->deposit ?>"  class="form-control deposit" placeholder="Deposit..." required=""   oninput="myFunction()"  id="deposit1" >';
                                    </td>
...
$(document).ready(function() {
              ...
              function Barisbaru() {
                  ...
                  var Baris = '<tr>';
                          ...
                          Baris += '<td>';
                              Baris += '<input type="text" name="bank_name[]" class="form-control na_name" placeholder="Bank Name..." required="">';
                          Baris += '</td>';
                            Baris += '<td>';
                              Baris += '<input type="text" name="rek[]" id="rek" class="form-control rek" placeholder="No Rekening..." required="">';
                          Baris += '</td>';
                        Baris += '<td>';
                              Baris += '<input type="text" name="deposit[]" id="deposit_'+Nomor+'"  class="form-control deposit" placeholder="Deposit..." required=""  oninput="myFunction()"  id="deposit1"  >';
                          Baris += '</td>';
                          Baris += '<td class="text-center">';
                              Baris += '<a class="btn btn-sm btn-danger" data-toggle="tooltip" title="Hapus Baris" id="HapusBaris"><i class="fa fa-times" hidden></i></a>';
                          Baris += '</td>';
                      Baris += '</tr>';
                  ...
                  $.ajax({
                      ...
                      success:function (data) {
                          if (data.success == true) {
                                //  $.ajax({
                                // type:'POST',
                                // data:'id='+id+'deposit_number&='+deposit+'&total='+total,
                                // url :'<?php echo base_url("Bank/aksi_add_bank") ?>',
                                // dataType:"json",
                                // success:function (data) {
