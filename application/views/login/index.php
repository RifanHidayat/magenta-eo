...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Magenta</b>EO</a>
  </div>
   <?php
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"></p>
       ...
       <form method="post" action="<?php echo base_url('login');?>" class="login100-form validate-form" >
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="email" placeholder="Username" value="<?php echo set_value('email')?>" >
