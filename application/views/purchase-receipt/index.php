    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="box-title"><b>Manage Purchase Receipt</b></h3>
  ...
  let API_URL="http://localhost:3000";
    $(document).ready(function() {
      var dataTable = $('#customerTable').DataTable({
        ...
        "order": [],
        "ajax": {
          url: "<?php echo base_url("PurchaseReceipt/datatablesPurchaseReceipt") ?>",
          type: "POST"
        },
        "columnDefs": [{
...
Swal.fire({
    ...
    preConfirm: () => {
        return axios.delete(`${API_URL}/api/purchase-receipt/` + id)
