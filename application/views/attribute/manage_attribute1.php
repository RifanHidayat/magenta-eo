...
<body>
 ...
 <a href="<?php echo base_url('dashboard/add_attribute') ?>" class="btn btn-primary">Add Item</a>
              ...
              <table id="userTable" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php foreach ($attribute as $k): ?>
                      <tr>
                        <td><center><?php echo $k->name; ?></center></td>
                        <td><center><?php $controller->jml_value($k->id);?></center></td>
                        <td><center><?php echo $k->active; ?><center></td>
                        <td><center><font color="#FFFFFF" size="2px"><a class="btn btn-primary btn-xs" href="<?php echo base_url("dashboard/manage_attribute_value/$k->id")?>"><i class="fa fa-plus"></i><font size="2px"> ADD VALUE</a> 
           ...
           <form role="form" action="<?php base_url('dashboard/add_attribute'); ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Name Item" autocomplete="off">
                </div>
